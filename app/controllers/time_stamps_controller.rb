    ...
    csv_data = CSV.generate do |csv|
      @scan_events.each_with_index do |scan_event, i|
        scan_event_hash = scan_event.attributes.slice(
          'hourly_worker_time_stamp', 'hourly_worker_in', 'hourly_worker_out',
        ...
        csv << scan_event_hash.values.prepend(scan_event.member.first_name, scan_event.member.last_name, scan_event.hourly_worker_time_stamp.to_i)
      end
    end
